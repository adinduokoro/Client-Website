    ...
    <section className='footer'>
      <div className="footer__container container">
        ...
        <div className="footer__copyright">
          <p>Copyright © 2023, Washington's Direct Firearm Training, LLC, website created by <a href="https://bytebackdigital.com/" target='_blank' style={{fontWeight: "500"}}>Byte Back Digital</a></p>
        </div>
      </div>
    </section>
  )
